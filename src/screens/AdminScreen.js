                     ...
                     <FadeInView key={ins.id} delay={i * 50}>
                        ...
                        >
                           ...
                           <View style={{ flexDirection: 'row', backgroundColor: C.bg, borderRadius: 20, padding: 15 }}>
                              <View style={{ flex: 1 }}>
                                 <Text style={{ fontSize: 8, fontWeight: '900', color: C.sub, letterSpacing: 1 }}>POURCENTAGE MEMBRES</Text>
         ...
         <View style={styles.modalOverlay}>
             <View style={[styles.modalSheet, { backgroundColor: C.bg, height: height * 0.85 }]}>
               ...
               <ScrollView style={{ padding: 20 }} showsVerticalScrollIndicator={false}>
                  ...
                  <TextInput style={[styles.input, { color: C.text, borderColor: C.border, backgroundColor: C.input }]} placeholder="Ex: Jean Mpolo" placeholderTextColor="#64748B" value={showEditModal ? editingUser?.name : newUser.name} onChangeText={v => showEditModal ? setEditingUser({...editingUser, name: v}) : setNewUser({...newUser, name: v})} />
            ...
            <View style={[styles.modalSheet, { backgroundColor: C.bg, height: height * 0.9, width: width * 0.95, borderRadius: 40 }]}>
               ...
               <ScrollView contentContainerStyle={{ padding: 25 }}>
                  ...
                  <View style={{ marginTop: 20, padding: 20, backgroundColor: brandColor + '08', borderRadius: 24, borderWidth: 1, borderColor: brandColor + '20' }}>
                     ...
                     <Text style={{ fontSize: 12, color: C.text, lineHeight: 18, fontWeight: '600' }}>
                        Le service des soins est en sur-capacité. Envisagez de renforcer l'équipe de nuit pour maintenir la qualité MDCD.
                     </Text>
                  </View>
        ...
        <View style={styles.modalOverlay}>
           <View style={[styles.modalSheet, { backgroundColor: C.bg, height: height * 0.92 }]}>
            ...
            <ScrollView style={{ padding: 20 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
              ...
              <TextInput style={[styles.input, { color: C.text, borderColor: C.border, backgroundColor: C.input }]} placeholder="Ex: 500000" placeholderTextColor="#64748B" keyboardType="numeric" value={newInsurance.monthly_flat_fee} onChangeText={v => setNewInsurance({...newInsurance, monthly_flat_fee: v})} />
                  ...
                  {bulkCategory === 'Autre' && (
                     <FadeInView style={{ marginBottom: 20 }}>
                        ...
                        <TextInput 
                           ...
                           placeholder="Ex: Maintenance, Services Externes..." 
                           placeholderTextColor="#64748B"
